        ...
        await showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(
                  'Tu pedido #$numRecibo ha sido registrado correctamente por un total de ${_formatearPrecio(total)}.\n\nAl terminar tu pago se ha generado tu Recibo de Compra oficial.',
                  textAlign: TextAlign.center,
