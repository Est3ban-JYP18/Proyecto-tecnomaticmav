          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              const PopupMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(Icons.business_outlined, color: Color(0xFF0047AB), size: 18),
                    SizedBox(width: 10),
                    Text('Sobre Nosotros', style: TextStyle(fontSize: 13)),
                  ],
                ),
              ),
              const PopupMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(Icons.support_agent_outlined, color: Color(0xFF20B2AA), size: 18),
                    SizedBox(width: 10),
                    Text('Contacto & PQRS', style: TextStyle(fontSize: 13)),
                  ],
                ),
              ),
            ],
